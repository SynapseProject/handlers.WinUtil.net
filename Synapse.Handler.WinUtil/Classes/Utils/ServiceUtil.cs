...
namespace Synapse.Handlers.WinUtil
{
	public class ServiceUtil
	{
		...
		public static ServiceConfig QueryService(string serviceName, string machineName)
		{
		...
		{
			ServiceController sc = new ServiceController( serviceName, machineName );
			ServiceConfig svc = QueryService( serviceName, machineName );
			...
			string[] loadOrderGroupDependencies = null, string[] svcDependencies = null)
		{
			...
			try
			{
				...
				{
					UpdateServiceDescription( serviceName, machineName, description);
				}
			}
			catch( Exception ex )
			{
